...
angular.module('canopi.directive').directive('uiGridSelectionRowHeaderButtonsCanopi', ['$templateCache', 'uiGridSelectionService', 'Dialog',
    function ($templateCache, uiGridSelectionService, Dialog) {
        return {
            replace: true,
            restrict: 'E',
