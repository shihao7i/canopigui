angular.module('canopi.app').controller('TechnicalOrderSearchController', ['$scope', '$log', '$location', '$rootScope', '$state', 'CommonUtilJsonService', 'OrderSearchJsonService', 'Cache', '$filter',
    ...
    function setupScopeMethods() {
        ...
        $scope.toSearch = function() {
	           ...
	           var promise = OrderSearchJsonService.getTechnicalOrderSummary(postObject);
	...
	function populatePicklistValues() {
		...
		$rootScope.$watch('picklists', function () {
			...
			if ($rootScope.picklists !== undefined) {
				...
				$scope.toProvisioningStatusList = $rootScope.picklists.toProvisioningStatusList;   
