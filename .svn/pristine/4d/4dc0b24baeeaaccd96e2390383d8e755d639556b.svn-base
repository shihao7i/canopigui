angular.module('canopi.directive').directive('gridViewDt', ['$window', '$compile', '$location', '$timeout', '$log',
                                               function ($window, $compile, $location, $timeout, $log) {
	'use strict';
    ...
    return {
        ...
        link: function (scope, element, attrs) {
        	...
        	$log.debug("===========  NEW gridViewDt directive created: id=" + attrs.id);
...
//            	$log.debug("----------- Destroy on table attrs.id=" + attrs.id);
    		...
    		{
    			$log.debug('cellEvent fired: data = ' + data);
    		};
            ...
            scope.$watch("tableInstance.columnDefs", function() {
            	...
            	$log.debug("===========  $watch on columnDefs hit");
