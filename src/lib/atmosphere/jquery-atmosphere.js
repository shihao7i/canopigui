  ...
  jQuery.atmosphere = {
    ...
    AtmosphereRequest: function(options) {
          ...
          success: function(data, textStatus, jqXHR) {
            if (rq.reconnect) {
              if (rq.maxRequest === -1 || rq.requestCount++ < rq.maxRequest) {
                ...
                jQuery.atmosphere.log(_request.logLevel, [
                  'AJAX reconnect maximum try reached ' + _request.requestCount
                ]);
                _onError(0, 'maxRequest reached');
              }
            }
      ...
      function _buildWebSocketUrl() {
        ...
        return decodeURI(
          jQuery('<a href="' + url + '"/>')[0].href.replace(/^http/, 'ws')
        );
      }
        ...
        _websocket.onclose = function(message) {
          ...
          if (reason === '') {
            switch (message.code) {
              case 1000:
                reason =
                  'Normal closure; the connection successfully completed whatever purpose for which ' +
                  'it was created.';
                break;
              case 1001:
                reason =
              ...
              case 1004:
                reason =
                  'The endpoint is terminating the connection because a data frame was received that ' +
                  'is too large.';
                break;
              case 1005:
                reason =
          ...
          if (_abordingConnection) {
            ...
            if (_requestCount++ < _request.maxReconnectOnClose) {
              ...
              if (_request.logLevel === 'warn') {
                jQuery.atmosphere.warn(
                  'Websocket error, reason: ' + message.reason
                );
              }
              _onError(0, 'maxReconnectOnClose reached');
            }
      ...
      function _trackMessageSize(message, request, response) {
        if (!_handleProtocol(request, message)) return true;
      ...
      function _reconnectWithFallbackTransport(errorMessage) {
        ...
        if (typeof _request.onTransportFailure !== 'undefined') {
          ...
          typeof jQuery.atmosphere.onTransportFailure !== 'undefined'
        ) {
        ...
        var reconnectInterval =
          _request.connectTimeout === -1 ? 0 : _request.connectTimeout;
        if (
      ...
      function _executeRequest(request) {
        ...
        if (
          rq.transport === 'jsonp' ||
          (rq.enableXDR && jQuery.atmosphere.checkCORSSupport())
        ) {
          _jsonp(rq);
          return;
        }
        ...
        if (
          ...
          ajaxRequest.onreadystatechange = function() {
            ...
            if (update) {
              ...
              if (
                jQuery.trim(responseText).length === 0 &&
                rq.transport === 'long-polling'
              ) {
                  ...
                  jQuery.atmosphere.iterate(function() {
                    if (
                      ...
                      try {
                        ...
                        _response.headers = parseHeaders(
              ...
              if (
                _response.responseBody.length !== 0 &&
      ...
      function _pushWebSocket(message) {
        var msg = jQuery.atmosphere.isBinary(message)
          ? message
        ...
        try {
          ...
          _reconnectWithFallbackTransport(
            'Websocket failed. Downgrading to Comet and resending ' + message
          );
          _pushAjaxMessage(message);
        }
      }
    ...
    checkCORSSupport: function() {
      if (
        ...
        +jQuery.browser.version.split('.')[0] < 11
      ) {
        return true;
      } else if (
        jQuery.browser.opera &&
        +jQuery.browser.version.split('.')[0] < 12.0
      ) {
        return true;
      }
      ...
      // KreaTV 4.1 -> 4.4
        ...
        jQuery.trim(navigator.userAgent).slice(0, 16) === 'KreaTVWebKit/531'
      ) {
        return true;
      }
      // KreaTV 3.8
        ...
        try {
          ...
          return (
            ...
            !(
              ...
              jQuery.browser.version.split('.')[0] === '1'
            )
          );
        } catch (e) {}
      }
