...
(function(window, angular, undefined) {
  ...
  MessageSelectorWatchers.prototype.expressionFnListener = function expressionFnListener(
    newValue,
    oldValue
  ) {
    var self = this;
  ...
  MessageSelectorWatchers.prototype.messageFnListener = function messageFnListener(
    newMessage,
    oldMessage
  ) {
  ...
  MessageFormatParser.prototype.startStringAtMatch = function startStringAtMatch(
    match
  ) {
  ...
  MessageFormatParser.prototype.assertChoiceKeyIsNew = function assertChoiceKeyIsNew(
    choiceKey,
    index
  ) {
