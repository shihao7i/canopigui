    ...
    f.each(replacementHash, function(key, value) {
      ...
      if (typeof value === 'object' && value !== null) {
        ...
        if (options.escapeInterpolation || o.escapeInterpolation) {
          str = str.replace(
            new RegExp([prefix, nextKey, unEscapingSuffix].join(''), 'g'),
            value
          );
          str = str.replace(
            new RegExp([prefix, nextKey, suffix].join(''), 'g'),
            f.escape(value)
          );
        } else {
          str = str.replace(
      ...
      if (o.fallbackNS.length) {
        for (var y = 0, lenY = o.fallbackNS.length; y < lenY; y++) {
          ...
          if (found) {
            ...
            var foundValue =
                found.indexOf(o.nsseparator) > -1
                  ? found.split(o.nsseparator)[1]
                  : found,
              notFoundValue =
                notFound.indexOf(o.nsseparator) > -1
  ...
  var sync = {
    ...
    postMissing: function(lng, ns, key, defaultValue, lngs) {
      ...
      if (o.sendMissingTo === 'fallback' && o.fallbackLng !== false) {
        ...
        (o.sendMissingTo === 'fallback' && o.fallbackLng === false)
      ) {
        urls.push({
          lng: lng,
