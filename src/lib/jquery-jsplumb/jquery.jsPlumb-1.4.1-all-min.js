  ...
  jsPlumbUtil = {
    ...
    pointOnLine: function(b, f, c) {
      var e = jsPlumbUtil.gradient(b, f),
        ...
        i =
          c > 0
            ? jsPlumbUtil.segmentMultipliers[k]
            : jsPlumbUtil.inverseSegmentMultipliers[k],
        d = Math.atan(e),
      ...
      this.fire = function(h, k, f) {
        if (!e && d[h]) {
          for (var g = 0; g < d[h].length; g++) {
            if (
              jsPlumbUtil.findWithFunction(b, function(i) {
                return i === h;
              }) != -1
            ) {
              d[h][g](k, f);
              ...
              try {
                ...
                jsPlumbUtil.log(
                  'jsPlumb: fire failed for event ' + h + ' : ' + l
                );
              }
            }
          }
      ...
      var p = function(v, r) {
        if (v) {
          for (var s = 0; s < v.childNodes.length; s++) {
            if (
              v.childNodes[s].nodeType != 3 &&
              v.childNodes[s].nodeType != 8
            ) {
              ...
              if (w && e[w] && e[w] > 0) {
                ...
                f[q][w] = {
                  id: w,
                  offset: { left: t.left - l.left, top: t.top - l.top }
                };
                g[w] = q;
              }
              p(v.childNodes[s]);
    ...
    this.updateOffsets = function(p) {
      ...
      if (o) {
        for (var r in o) {
          ...
          f[m][r] = {
            id: r,
            offset: { left: q.left - l.left, top: q.top - l.top }
          };
          g[r] = m;
        }
      }
      ...
      while (m != null && m != v) {
        ...
        if (r && i[r]) {
          ...
          if (f[r][l] == null) {
            ...
            f[r][l] = {
              id: l,
              offset: { left: w.left - o.left, top: w.top - o.top }
            };
            g[l] = r;
          }
          break;
...
(function() {
  ...
  var A = function(E, F) {
    ...
    z = (window.jsPlumbUIComponent = function(X) {
      ...
      R.hoverClass =
        X.hoverClass || R._jsPlumb.Defaults.HoverClass || n.Defaults.HoverClass;
    ...
    v = (window.overlayCapableJsPlumbUIComponent = function(J) {
      ...
      var H = function(V) {
          ...
          if (l(V)) {
            var S = V[0],
              U = n.extend({ component: R, _jsPlumb: R._jsPlumb }, V[1]);
            if (V.length == 3) {
              n.extend(U, V[2]);
            }
      ...
      if (J.label) {
        var N = J.labelLocation || R.defaultLabelLocation || 0.5,
          O =
            J.labelStyle ||
            R._jsPlumb.Defaults.LabelStyle ||
      ...
      this.setLabel = function(S) {
        ...
        if (!T) {
          var U =
            S.constructor == String || S.constructor == Function
              ? { label: S }
              : S;
          T = Q(U);
  ...
  var u = function(F) {
    ...
    var K = null,
          ...
          if (bg) {
            if (bc.isDragSupported(bb) && !bc.isAlreadyDraggable(bb)) {
              ...
              bf[ba] = ae(bf[ba], function() {
                ...
                a0.select({ source: bb }).addClass(
                  a0.elementDraggingClass + ' ' + a0.sourceElementDraggingClass,
                  true
                );
                a0.select({ target: bb }).addClass(
                  a0.elementDraggingClass + ' ' + a0.targetElementDraggingClass,
                  true
                );
              });
              ...
              bf[a8] = ae(bf[a8], function() {
                ...
                a0.select({ source: bb }).removeClass(
                  a0.elementDraggingClass + ' ' + a0.sourceElementDraggingClass,
                  true
                );
                a0.select({ target: bb }).removeClass(
                  a0.elementDraggingClass + ' ' + a0.targetElementDraggingClass,
                  true
                );
              });
      ...
      al = function(ba, be) {
        ...
        if (a7.sourceEndpoint && a7.sourceEndpoint.connectorOverlays) {
          ...
          for (
            var bd = 0, bc = a7.sourceEndpoint.connectorOverlays.length;
            bd < bc;
            bd++
          ) {
        ...
        if (
          !a7['pointer-events'] &&
          a7.sourceEndpoint &&
          a7.sourceEndpoint.connectorPointerEvents
        ) {
    ...
    this.addEndpoint = function(ba, bb, bl) {
      ...
      a9.paintStyle =
        a9.paintStyle || a0.Defaults.EndpointStyle || n.Defaults.EndpointStyle;
      ba = au(ba);
      var bd = [],
      ...
      if (a9) {
        ...
        if (a7.uuids) {
          ...
          if (a7.sourceEndpoint && a7.targetEndpoint) {
            ...
            P(be, function(bg) {
              if (
                (bg.sourceId == be && bg.targetId == bd) ||
                (bg.targetId == be && bg.sourceId == bd)
              ) {
    ...
    var M = function(bc, bd) {
      var a7 = { length: bc.length, each: I(bc, bd), get: L(bc) },
        bb = [
          'setHover',
          'removeAllOverlays',
          'setLabel',
          ...
          if (l(bd)) {
            if (l(bd[0]) || x(bd[0])) {
              if (bd.length == 2 && x(bd[0]) && t(bd[1])) {
                var a7 = n.extend(
                  { elementId: a9, jsPlumbInstance: a0 },
                  bd[1]
                );
                ba = bb(bd[0], a7);
              } else {
    ...
    var aI = {},
      ...
      T = function(a7, a8) {
        a7.paintStyle =
          a7.paintStyle ||
          a0.Defaults.EndpointStyles[a8] ||
          a0.Defaults.EndpointStyle ||
          n.Defaults.EndpointStyles[a8] ||
          n.Defaults.EndpointStyle;
        a7.hoverPaintStyle =
          a7.hoverPaintStyle ||
          a0.Defaults.EndpointHoverStyles[a8] ||
          a0.Defaults.EndpointHoverStyle ||
          n.Defaults.EndpointHoverStyles[a8] ||
          n.Defaults.EndpointHoverStyle;
        a7.anchor =
          a7.anchor ||
          a0.Defaults.Anchors[a8] ||
          a0.Defaults.Anchor ||
          n.Defaults.Anchors[a8] ||
          n.Defaults.Anchor;
        a7.endpoint =
          a7.endpoint ||
          a0.Defaults.Endpoints[a8] ||
          a0.Defaults.Endpoint ||
          n.Defaults.Endpoints[a8] ||
          n.Defaults.Endpoint;
      };
      ...
      _doOne = function(bn) {
        ...
        var bk = n.extend({}, a8.dropOptions || {}),
          bj = function() {
            ...
            var bv = proxyComponent.isDropAllowed(
              bx.sourceId,
              E(bn),
              bx.scope,
              bx,
            ...
            if (bv) {
              ...
              if (bB.anchor.positionFinder != null) {
                var by = bf.getUIPosition(arguments, a0.getZoom()),
                  bu = r(bn, a0),
                  bz = a(bn),
                  bt = bB.anchor.positionFinder(
                    by,
                    bu,
                    bz,
                    bB.anchor.constructorParams
                  );
                bB.anchor.x = bt[0];
                bB.anchor.y = bt[1];
              }
              ...
              if (
                bx.endpoints[1]._makeTargetCreator &&
                bx.endpoints[1].connections.length < 2
              ) {
    ...
    this.makeSource = function(bb, bc, bh) {
      ...
      var bf = n.CurrentLibrary,
        ...
        a7 = function(bp) {
          var bj = E(bp),
            br = function() {
              return a9.parent == null
                ? a9.parent
                : a9.parent === 'parent'
                  ? bf.getElementObject(bf.getDOMElement(bp).parentNode)
                  : bf.getElementObject(a9.parent);
            },
          ...
          var bl = function(by) {
            ...
            if (a9.filter) {
              var bF = bf.getOriginalEvent(by),
                bu = jsPlumbUtil.isString(a9.filter)
                  ? aD(bF, bp, a9.filter)
                  : a9.filter(bF, bp);
              if (bu === false) {
                return;
            ...
            if (a9.parent) {
              var bz = br(),
                bx = E(bz);
              bD = Q({ elId: bx }).o;
              (bI = ((by.pageX || by.page.x) - bD.left) / bD.width),
                (bH = ((by.pageY || by.page.y) - bD.top) / bD.height);
            }
            var bG = {};
            n.extend(bG, a9);
            bG.isSource = true;
            ...
            if (a9.parent) {
              var bv =
                bG.container || a0.Defaults.Container || n.Defaults.Container;
              if (bv) {
                bG.container = bv;
              } else {
    ...
    this.setId = function(a9, ba, be) {
      var a7 = a9.constructor == String ? a9 : a0.getId(a9),
        a8 = a0.getConnections({ source: a7, scope: '*' }, true),
        bc = a0.getConnections({ target: a7, scope: '*' }, true);
      ba = '' + ba;
      if (!be) {
    ...
    this.adjustForParentOffsetAndScroll = function(bc, a9) {
      ...
      if (ba != null) {
        var a8 =
            ba.tagName.toLowerCase() === 'body'
              ? { left: 0, top: 0 }
              : r(ba, a0),
          bb =
            ba.tagName.toLowerCase() === 'body'
              ? { left: 0, top: 0 }
              : { left: ba.scrollLeft, top: ba.scrollTop };
...
(function() {
  jsPlumb.AnchorManager = function(w) {
    var e = {},
      ...
      k = function(K, L, G, C, H, A) {
        ...
        var B = Math.atan2(C.centery - G.centery, C.centerx - G.centerx),
          ...
          E =
            (G.left <= C.left && G.right >= C.left) ||
            (G.left <= C.right && G.right >= C.right) ||
            (G.left <= C.left && G.right >= C.right) ||
            (C.left <= G.left && C.right >= G.right),
          J =
            (G.top <= C.top && G.bottom >= C.top) ||
            (G.top <= C.bottom && G.bottom >= C.bottom) ||
            (G.top <= C.top && G.bottom >= C.bottom) ||
            (C.top <= G.top && C.bottom >= G.bottom),
          I = function(M) {
            return [
              H.isContinuous ? H.verifyEdge(M[0]) : M[0],
              A.isContinuous ? A.verifyEdge(M[1]) : M[1]
            ];
          },
          ...
          C = function(M, T, I, L, R, Q, H) {
            if (L.length > 0) {
              var P = q(L, s[M]),
                ...
                G = z(M, T, I, P, R, Q, N);
              var U = function(X, W) {
                var V = p.adjustForParentOffsetAndScroll(
                  [W[0], W[1]],
                  X.canvas
                );
    ...
    this.newConnection = function(D) {
      var F = D.sourceId,
        ...
        B = function(G, H, J, I, K) {
          ...
          jsPlumbUtil.addToList(g, I, [
            K,
            H,
            J.constructor == jsPlumb.DynamicAnchor
          ]);
        };
            ...
            if (E == I && (H || N)) {
              ...
              if (!T) {
                T = k(
                  ...
                  A.o,
                  K.o,
                  G.endpoints[0].anchor,
                  G.endpoints[1].anchor
                );
                L[Y] = T;
              }
              if (H) {
    ...
    var t = function(C) {
      ...
      var F = C.faces || ['top', 'right', 'bottom', 'left'],
        B = !(C.clockwise === false),
        K = {},
        I = { top: 'bottom', right: 'left', left: 'right', bottom: 'top' },
        E = { top: 'right', right: 'bottom', left: 'top', bottom: 'left' },
        G = { top: 'left', right: 'top', left: 'bottom', bottom: 'right' },
        D = B ? E : G,
        A = B ? G : E,
        J = C.cssClass || '';
  ...
  jsPlumb.Anchor = function(k) {
    ...
    this.compute = function(p) {
      ...
      if (d != null) {
        ...
        e = [
          o[0] + h.x * l[0] + h.offsets[0],
          o[1] + h.y * l[1] + h.offsets[1]
        ];
    ...
    this.equals = function(l) {
      ...
      return (
        this.x == l.x &&
        this.y == l.y &&
        this.offsets[0] == l.offsets[0] &&
        this.offsets[1] == l.offsets[1] &&
        n[0] == m[0] &&
        n[1] == m[1]
      );
    };
  ...
  jsPlumb.DynamicAnchor = function(g) {
    ...
    var n = [],
      m = this,
      l = function(i) {
        return i.constructor == jsPlumb.Anchor
          ? i
          : g.jsPlumbInstance.makeAnchor(i, g.elementId, g.jsPlumbInstance);
      };
    ...
    var d = n.length > 0 ? n[0] : null,
      ...
      e = function(t, q, p, u, o) {
        var i = u[0] + t.x * o[0],
          ...
          r = u[1] + o[1] / 2;
        return (
          Math.sqrt(Math.pow(q - i, 2) + Math.pow(p - v, 2)) +
          Math.sqrt(Math.pow(s - i, 2) + Math.pow(r - v, 2))
        );
      },
      c =
        g.selector ||
    ...
    this.getCurrentLocation = function() {
      return (
        m.getUserDefinedLocation() ||
        (d != null ? d.getCurrentLocation() : null)
      );
    };
  ...
  var b = function(c, h, e, d, g, f) {
    jsPlumb.Anchors[g] = function(k) {
      var i = k.jsPlumbInstance.makeAnchor(
        [c, h, e, d, 0, 0],
        k.elementId,
        k.jsPlumbInstance
      );
  ...
  jsPlumb.Defaults.DynamicAnchors = function(c) {
    return c.jsPlumbInstance.makeAnchors(
  ...
  jsPlumb.Anchors.AutoDefault = function(d) {
    var c = d.jsPlumbInstance.makeDynamicAnchor(
      jsPlumb.Defaults.DynamicAnchors(d)
    );
    c.type = 'AutoDefault';
    return c;
  };
  var a = function(d, c) {
    jsPlumb.Anchors[d] = function(f) {
      var e = f.jsPlumbInstance.makeAnchor(
        ['Continuous', { faces: c }],
        f.elementId,
        f.jsPlumbInstance
      );
  ...
  jsPlumb.Anchors.Assign = b(0, 0, 0, 0, 'Assign', function(d, e) {
    ...
    d.positionFinder =
      c.constructor == String ? e.jsPlumbInstance.AnchorPositionFinders[c] : c;
    ...
    var f = {
        ...
        Path: function(u) {
          ...
          for (var r = 0; r < s.length - 1; r++) {
            var o = Math.sqrt(
              Math.pow(s[r][2] - s[r][0]) + Math.pow(s[r][3] - s[r][1])
            );
            q += o;
      ...
      m = function(u, t) {
        ...
        for (var r = 0; r < u.length; r++) {
          var q = u[r][0] - 0.5,
            p = u[r][1] - 0.5;
          v.push([
            0.5 + (q * Math.cos(s) - p * Math.sin(s)),
            0.5 + (q * Math.sin(s) + p * Math.cos(s)),
            u[r][2],
            u[r][3]
          ]);
        }
  ...
  jsPlumb.Endpoint = function(h) {
    ...
    this.getDefaultType = function() {
      return {
        ...
        paintStyle:
          r._jsPlumb.Defaults.EndpointStyle || jsPlumb.Defaults.EndpointStyle,
        endpoint: r._jsPlumb.Defaults.Endpoint || jsPlumb.Defaults.Endpoint,
        hoverPaintStyle:
          r._jsPlumb.Defaults.EndpointHoverStyle ||
          jsPlumb.Defaults.EndpointHoverStyle,
        overlays:
          r._jsPlumb.Defaults.EndpointOverlays ||
    ...
    this.setEndpoint(
      h.endpoint || t.Defaults.Endpoint || jsPlumb.Defaults.Endpoint || 'Dot'
    );
    R = U;
    var v = r.setHover;
    r.setHover = function() {
    ...
    this.addConnection = function(i) {
      ...
      r[(r.connections.length > 0 ? 'add' : 'remove') + 'Class'](
        t.endpointConnectedClass
      );
          ...
          if (ad || ac._forceDetach || r.isDetachAllowed(ac)) {
            ...
            if (!ag) {
              ...
              if (ac.endpointsToDeleteOnDetach) {
                for (
                  var af = 0;
                  af < ac.endpointsToDeleteOnDetach.length;
                  af++
                ) {
            ...
            if (ac.getConnector() != null) {
              q.removeElements(
                ac.getConnector().getDisplayElements(),
                ac.parent
              );
            }
    ...
    this.detachFrom = function(ae, ad, ab) {
      ...
      for (var ac = 0; ac < r.connections.length; ac++) {
        if (
          r.connections[ac].endpoints[1] == ae ||
          r.connections[ac].endpoints[0] == ae
        ) {
    ...
    this.setElement = function(ae, ab) {
      ...
      V = t.getId(I);
      r.elementId = V;
      var af = h.getParentFromParams({ source: ag, container: ab }),
    ...
    var C = function(ac) {
      ...
      if (ac != null) {
        for (var ad = 0; ad < r.connections.length; ad++) {
          if (
            r.connections[ad].sourceId == ac ||
            r.connections[ad].targetId == ac
          ) {
            ab = ad;
            break;
          }
    ...
    this.paint = function(af) {
      ...
      if (!al || r.timestamp !== al) {
        ...
        if (at) {
          ...
          U.compute(
            ai,
            r.anchor.getOrientation(r),
            r.paintStyleInUse,
            ag || r.paintStyleInUse
          );
        ...
        if (m.endpoints[i] == f) {
          if (s && m.suspendedEndpoint) {
            ...
            if (
              ...
              m._forceReattach ||
              m._forceDetach ||
              !m.endpoints[i == 0 ? 1 : 0].detach(m, false, false, true, ab)
            ) {
              m.setHover(false);
    ...
    var p = function(ac, ah, af, ai) {
      if ((h.isTarget || ah) && k.isDropSupported(I)) {
        ...
        var ab = k.dragEvents.drop,
          ...
          ae = function() {
            ...
            var aj = k.getDropEvent(arguments),
              ...
              aq = B[al];
            var ao =
              aq.suspendedEndpoint &&
              (aq.suspendedEndpoint.id == r.id ||
                (r.referenceEndpoint &&
                  aq.suspendedEndpoint.id == r.referenceEndpoint.id));
            if (ao) {
            ...
            if (aq != null) {
              var at =
                  aq.floatingAnchorIndex == null ? 1 : aq.floatingAnchorIndex,
                au = at == 0 ? 1 : 0;
              if (aw) {
              ...
              if (r.isFull()) {
                r.fire(
                  'maxConnections',
                  { endpoint: r, connection: aq, maxConnections: L },
                  aj
                );
              }
              if (
                ...
                if (aq.suspendedEndpoint && aq.suspendedEndpoint.id != r.id) {
                  ...
                  if (
                    !aq.isDetachAllowed(aq) ||
                    !aq.endpoints[at].isDetachAllowed(aq) ||
                    !aq.suspendedEndpoint.isDetachAllowed(aq) ||
                    !t.checkCondition('beforeDetach', aq)
                  ) {
                    ap = false;
                  }
                }
                    ...
                    X(
                      {
                        ...
                        sourceEndpoint:
                          at == 0 ? aq.suspendedEndpoint : aq.endpoints[0],
                        targetEndpoint:
                          at == 1 ? aq.suspendedEndpoint : aq.endpoints[1],
                        connection: aq
                      },
                      true,
                      aj
                ...
                ap =
                  ap &&
                  r.isDropAllowed(aq.sourceId, aq.targetId, aq.scope, aq, r);
                if (ap) {
                  ak();
                } else {
                  am();
        ...
        ad[ag] = t.wrap(ad[ag], function() {
          ...
          if (an != null) {
            var aj =
              an.floatingAnchorIndex == null ? 1 : an.floatingAnchorIndex;
            var am =
              (r.isTarget && an.floatingAnchorIndex != 0) ||
              (an.suspendedEndpoint &&
                r.referenceEndpoint &&
                r.referenceEndpoint.id == an.suspendedEndpoint.id);
            if (am) {
              ...
              r[(al ? 'remove' : 'add') + 'Class'](
                t.endpointDropForbiddenClass
              );
        ...
        ad[i] = t.wrap(ad[i], function() {
          ...
          if (am != null) {
            var aj =
              am.floatingAnchorIndex == null ? 1 : am.floatingAnchorIndex;
            var al =
              (r.isTarget && am.floatingAnchorIndex != 0) ||
              (am.suspendedEndpoint &&
                r.referenceEndpoint &&
                r.referenceEndpoint.id == am.suspendedEndpoint.id);
            if (al) {
              r.removeClass(t.endpointDropAllowedClass);
              r.removeClass(t.endpointDropForbiddenClass);
  ...
  jsPlumb.Connection = function(b) {
    ...
    this.getDefaultType = function() {
      return {
        ...
        paintStyle:
          l._jsPlumb.Defaults.PaintStyle || jsPlumb.Defaults.PaintStyle,
        connector: l._jsPlumb.Defaults.Connector || jsPlumb.Defaults.Connector,
        hoverPaintStyle:
          l._jsPlumb.Defaults.HoverPaintStyle ||
          jsPlumb.Defaults.HoverPaintStyle,
        overlays:
          l._jsPlumb.Defaults.ConnectorOverlays ||
    ...
    this.setConnector = function(Q, O) {
      ...
      if (
        ...
        jsPlumb.ConnectorEditors[d.type] &&
        d.isEditable()
      ) {
    ...
    if (b.sourceEndpoint) {
      this.source =
        b.sourceEndpoint.endpointWillMoveTo || b.sourceEndpoint.getElement();
    }
    if (b.targetEndpoint) {
      ...
      A = function(O, U, P, R, S, Q, T) {
        ...
        if (O) {
          ...
          var aa =
            P.endpoints[U] ||
            P.endpoint ||
            o.Defaults.Endpoints[U] ||
            jsPlumb.Defaults.Endpoints[U] ||
            o.Defaults.Endpoint ||
          ...
          var Y =
            P.endpointStyles[U] ||
            P.endpointStyle ||
            o.Defaults.EndpointStyles[U] ||
            jsPlumb.Defaults.EndpointStyles[U] ||
          ...
          var X =
            P.endpointHoverStyles[U] ||
            P.endpointHoverStyle ||
            o.Defaults.EndpointHoverStyles[U] ||
            jsPlumb.Defaults.EndpointHoverStyles[U] ||
            o.Defaults.EndpointHoverStyle ||
            jsPlumb.Defaults.EndpointHoverStyle;
          if (T != null) {
            if (X == null) {
              X = {};
          ...
          var W = P.anchors
              ...
              : P.anchor
                ? P.anchor
                : x(o.Defaults.Anchors[U], S) ||
                  x(jsPlumb.Defaults.Anchors[U], S) ||
                  x(o.Defaults.Anchor, S) ||
                  x(jsPlumb.Defaults.Anchor, S),
    ...
    var I =
      b.reattach ||
      l.endpoints[0].reattachConnections ||
      l.endpoints[1].reattachConnections ||
      ...
      if (r) {
        ...
        if (Q == null || Q != v) {
          var aj = o.updateOffset({
            ...
            V = o.updateOffset({ elId: af, timestamp: Q }).o,
    ...
    var N =
      b.type || l.endpoints[0].connectionType || l.endpoints[1].connectionType;
    if (N) {
...
(function() {
  ...
  jsPlumb.Connectors.AbstractConnector = function(z) {
    ...
    var q = function(R) {
      ...
      var B = jsPlumbUtil.segment(R.sourcePos, R.targetPos),
        ...
        E = R.lineWidth || 1,
        Q =
          R.sourceEndpoint.anchor.orientation ||
          R.sourceEndpoint.anchor.getOrientation(R.sourceEndpoint),
        C =
          R.targetEndpoint.anchor.orientation ||
          R.targetEndpoint.anchor.getOrientation(R.targetEndpoint),
      ...
      I.anchorOrientation = I.opposite
        ? 'opposite'
        : I.orthogonal
          ? 'orthogonal'
          : 'perpendicular';
  ...
  var c = (jsPlumb.Overlays.AbstractOverlay = function(g) {
    ...
    this.endpointLoc =
      g.endpointLocation == null ? [0.5, 0.5] : g.endpointLocation;
    ...
    this.draw = function(v, z) {
      ...
      if (v.pointAlongPathFrom) {
        if (e.isString(g.loc) || g.loc > 1 || g.loc < 0) {
          ...
          (r = v.pointAlongPathFrom(o, (i * g.length) / 2, true)),
            (w = v.pointOnPath(o, true)),
          ...
          if (g.loc == 1) {
            ...
            if (g.loc == 0) {
              ...
              (r = v.pointAlongPathFrom(g.loc, (i * g.length) / 2)),
                (w = v.pointOnPath(g.loc)),
                (n = e.pointOnLine(r, w, g.length));
            }
          }
        }
  ...
  jsPlumb.Overlays.Diamond = function(g) {
    g = g || {};
    var e = g.length || 40,
      f = jsPlumb.extend(g, { length: e / 2, foldback: 2 });
  ...
  var a = function(f) {
    ...
    var g = function() {
      ...
      var o =
        f._jsPlumb.overlayClass +
        ' ' +
        (m.cssClass ? m.cssClass : f.cssClass ? f.cssClass : '');
      e.className = o;
        ...
        var D = (u + J) / 2,
          ...
          F =
            n == Infinity || n == -Infinity
              ? 0
              : Math.abs((d / 2) * Math.sin(K)),
          I =
            n == Infinity || n == -Infinity
              ? 0
              : Math.abs((d / 2) * Math.cos(K)),
          o = a(u, r, J, H),
  ...
  var l = {
    ...
    v = function(O, J, G, E, K) {
      ...
      for (var L = 0; L < G.gradient.stops.length; L++) {
        var I =
            K.segment == 1 || K.segment == 2
              ? L
              : G.gradient.stops.length - 1 - L,
    ...
    x = function(L, H, F, E, I) {
      ...
      H.setAttribute(
        c,
        F.fillStyle ? jsPlumbUtil.convertStyle(F.fillStyle, true) : m
      );
      H.setAttribute(
        A,
        F.strokeStyle ? jsPlumbUtil.convertStyle(F.strokeStyle, true) : m
      );
      if (F.lineWidth) {
...
(function() {
  ...
  var a = {
    ...
    f = function(z, y) {
      for (
        var u = [],
          ...
          p = [],
          r = [],
          q = [[1, 0.6, 0.3, 0.1], [0.4, 0.6, 0.6, 0.4], [0.1, 0.3, 0.6, 1]],
          x = 0;
        x <= w;
        x++
      ) {
      ...
      p = a.square(t);
      for (x = q = 0; x < r; x++) {
        (t = a.subtract(z, h(y, w, u[x], null, null))),
          (t = a.square(t)),
          t < p && ((p = t), (q = u[x]));
      }
      t = a.subtract(z, y[w]);
        ...
        case 1:
          ...
          for (o = 1; o < C; o++) {
            (q = v * D[o].x + B * D[o].y + s),
              q > u
                ? (u = q)
                : q < max_distance_below && (max_distance_below = q);
          }
          q = B;
          o = 0 * q - 1 * v;
          u = (1 * (s - u) - 0 * q) * (1 / o);
    ...
    h = function(n, m, q, s, p) {
      ...
      for (n = 1; n <= m; n++) {
        for (r = 0; r <= m - n; r++) {
          o[n] || (o[n] = []),
            o[n][r] || (o[n][r] = {}),
            (o[n][r].x = (1 - q) * o[n - 1][r].x + q * o[n - 1][r + 1].x),
            (o[n][r].y = (1 - q) * o[n - 1][r].y + q * o[n - 1][r + 1].y);
        }
      }
      if (null != s) {
        for (r = 0; r <= m; r++) {
    ...
    k = function(n, m, q) {
      ...
      for (
        var s = l(n, m), p = 0, o = 0 < q ? 1 : -1, r = null;
        p < Math.abs(q);
