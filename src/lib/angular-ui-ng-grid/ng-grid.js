(function(e, t) {
  ...
  var v = function(e, t, o, i) {
    ...
    var r,
      ...
      a = !1,
      s = !1,
      c = e.selectionProvider.lastClickedRow.rowIndex,
    ...
    if (
      (e.col && (r = g.indexOf(e.col)),
      37 !== l && 38 !== l && 39 !== l && 40 !== l && 9 !== l && 13 !== l)
    )
      return !0;
    if (e.enableCellSelection) {
      ...
      var u = e.showSelectionCheckbox ? 1 === e.col.index : 0 === e.col.index,
        ...
        h =
          e.$index === e.renderedColumns.length - 1 ||
          e.$index === e.renderedColumns.length - 2,
      ...
      if (37 === l || (9 === l && o.shiftKey)) {
        ...
        (39 === l || (9 === l && !o.shiftKey)) &&
          (h
            ? p && 9 === l && !o.shiftKey
              ? (i.$viewport.scrollLeft(0),
                (r = e.showSelectionCheckbox ? 1 : 0),
                (a = !0))
    ...
    if (
      (0 !== c &&
      (38 === l || (13 === l && o.shiftKey) || (9 === l && o.shiftKey && s))
        ? (C = -1)
        : c !== w.length - 1 &&
      ...
      b.beforeSelectionChange(b, o) &&
        ...
        e.selectionProvider.lastClickedRow.renderedRowIndex >=
        e.renderedRows.length - n - 2
    ...
    return (
      e.enableCellSelection &&
        setTimeout(function() {
          e.domAccessProvider.focusCellElement(
            e,
            e.renderedColumns.indexOf(g[r])
          );
        }, 3),
      !1
    );
  ...
  String.prototype.trim ||
    ...
    Array.prototype.indexOf ||
      (Array.prototype.indexOf = function(e) {
        ...
        for (
          n = 0 > n ? Math.ceil(n) : Math.floor(n), 0 > n && (n += t);
          t > n;
          n++
        )
        ...
        var n = {},
          ...
          i = function() {
            ...
            e.appendTo('body'),
              ...
              e.attr('style', ''),
              e.append(
                '<span style="font-family: Verdana, Helvetica, Sans-Serif; font-size: 14px;"><strong>M</strong></span>'
              ),
              (n.LetterW = e
                .children()
                .first()
        ...
        return (
          ...
          (n.UpdateGridLayout = function(e, t) {
            ...
            (t.elementDims.rootMaxW = t.$root.width()),
              t.$root.is(':hidden') &&
                (t.elementDims.rootMaxW = n.getRealWidth(t.$root)),
          ...
          (n.BuildStyles = function(o, i, r) {
            ...
            s ||
              ...
              s[0] ||
                (s = t(
                  "<style id='" + c + "' type='text/css' rel='stylesheet' />"
                ).appendTo(i.$root))),
              s.empty();
            ...
            for (var f = 0; g.length > f; f++) {
              var h = g[f];
              if (h.visible !== !1) {
                var p = h.pinned ? i.$viewport.scrollLeft() + d : d;
                (l +=
                  '.' +
                  c +
                  ' .col' +
            ...
            e.isIe
              ? (s[0].styleSheet.cssText = l)
              : s[0].appendChild(document.createTextNode(l)),
              (i.$styleSheet = s),
              r && (o.adjustScrollLeft(i.$viewport.scrollLeft()), n.digest(o));
          }),
          (n.setColLeft = function(t, n, i) {
            if (i.$styleSheet) {
              ...
              r ||
                (r = o[t.index] = RegExp(
                  '.col' + t.index + ' { width: [0-9]+px; left: [0-9]+px'
                ));
        ...
        return (
          ...
          (t.getSortFn = function(n, o) {
            ...
            if (t.colSortFnCache[n.field]) i = t.colSortFnCache[n.field];
              ...
              (i = n.sortingAlgorithm),
                (t.colSortFnCache[n.field] = n.sortingAlgorithm);
            else {
              if (((r = o[0]), !r)) return i;
              (i = t.guessSortFn(e(n.field)(r))),
  ...
  (w.prototype.toggleExpand = function() {
    ...
    (w.prototype.notifyChildren = function() {
      for (
        var e = Math.max(this.rowFactory.aggCache.length, this.children.length),
          t = 0;
        e > t;
        t++
      )
        if (
          (this.aggChildren[t] &&
            ((this.aggChildren[t].entity[s] = this.collapsed),
            this.collapsed && this.aggChildren[t].setExpand(this.collapsed)),
  ...
  var C = function(e, n, o, l, a, s) {
      ...
      (c.colDef = e.colDef),
        ...
        (c.enableCellEdit =
          void 0 !== d.enableCellEdit ? d.enableCellEdit : e.enableCellEdit),
        ...
        (c.originalIndex = c.index),
        (c.groupable = s.isNullOrUndefined(d.groupable) || d.groupable),
        e.enableSort &&
          (c.sortable = s.isNullOrUndefined(d.sortable) || d.sortable),
        e.enableResize &&
          (c.resizable = s.isNullOrUndefined(d.resizable) || d.resizable),
        e.enablePinning &&
          (c.pinnable = s.isNullOrUndefined(d.pinnable) || d.pinnable),
        ...
        (c.headerCellTemplate =
          d.headerCellTemplate || a.get('headerCellTemplate.html')),
        (c.cellTemplate =
          d.cellTemplate ||
          a
            .get('cellTemplate.html')
            .replace(g, c.cellFilter ? '|' + c.cellFilter : '')),
        c.enableCellEdit &&
          ((c.cellEditTemplate = a.get('cellEditTemplate.html')),
          (c.editableCellTemplate =
            d.editableCellTemplate || a.get('editableCellTemplate.html'))),
        d.cellTemplate &&
          !h.test(d.cellTemplate) &&
          (c.cellTemplate = t.ajax({
            type: 'GET',
            url: d.cellTemplate,
            async: !1
          }).responseText),
        ...
        (c.onMouseMove = function(e) {
          ...
          return (
            (c.width =
              c.minWidth > i ? c.minWidth : i > c.maxWidth ? c.maxWidth : i),
            l.BuildStyles(n, o),
            !1
          );
        }),
  ...
  (S.prototype.changeUserSelect = function(e, t) {
    ...
    (S.prototype.selectInputElement = function(e) {
      ...
      (l.colToMove = void 0),
        ...
        (l.assignEvents = function() {
          n.config.jqueryUIDraggable && !n.config.enablePinning
            ...
            : (n.$groupPanel
                .on('mousedown', l.onGroupMouseDown)
                .on('dragover', l.dragOver)
                .on('drop', l.onGroupDrop),
              n.$headerScroller
                .on('mousedown', l.onHeaderMouseDown)
                .on('dragover', l.dragOver),
              n.config.enableColumnReordering &&
                !n.config.enablePinning &&
                n.$headerScroller.on('drop', l.onHeaderDrop)),
          ...
          if (n.config.jqueryUIDraggable)
            ...
            angular.forEach(e, function(e) {
              e.className &&
                ...
                e.addEventListener &&
                  e.addEventListener('dragstart', l.dragStart));
            }),
            ...
            i &&
              (n.config.jqueryUIDraggable ||
                ...
                this.addEventListener &&
                  this.addEventListener('dragstart', l.dragStart),
                -1 !== navigator.userAgent.indexOf('MSIE') &&
          ...
          l.groupToMove
            ? ((i = t(e.target).closest('.ngGroupElement')),
              'ngGroupPanel' === i.context.className
                ? (o.configGroups.splice(l.groupToMove.index, 1),
                  o.configGroups.push(l.groupToMove.groupName))
    ...
    y = function(e, t) {
      (e.maxRows = function() {
        ...
        (e.pageForward = function() {
          ...
          e.totalServerItems > 0
            ? (e.pagingOptions.currentPage = Math.min(t + 1, e.maxPages()))
            : e.pagingOptions.currentPage++;
        }),
    ...
    T = function(i, r, l, a, c, g, d, u, f, p, m) {
      ...
      (w.maxCanvasHt = 0),
        ...
        (w.config.showSelectionCheckbox =
          w.config.showSelectionCheckbox &&
          w.config.enableColumnHeavyVirt === !1),
        (w.config.enablePinning =
          w.config.enablePinning && w.config.enableColumnHeavyVirt === !1),
        (w.config.selectWithCheckboxOnly =
          w.config.selectWithCheckboxOnly &&
          w.config.showSelectionCheckbox !== !1),
        (w.config.pinSelectionCheckbox = w.config.enablePinning),
        'string' == typeof r.columnDefs &&
          (w.config.columnDefs = i.$eval(r.columnDefs)),
        (w.rowCache = []),
        (w.rowMap = []),
        (w.gridId = 'ng' + d.newId()),
        (w.$root = null),
        ...
        (w.calcMaxCanvasHeight = function() {
          return w.config.groups.length > 0
          ...
          return e
            ? (d.forIn(e, function(e, t) {
                -1 === w.config.excludeProperties.indexOf(t) &&
                  w.config.columnDefs.push({ field: t });
              }),
              void 0)
        ...
        (w.buildColumns = function() {
          ...
          if (
                ...
                new C(
                  {
                    colDef: {
                      ...
                      resizable: !1,
                      groupable: !1,
                      headerCellTemplate: g.get(
                        i.gridId + 'checkboxHeaderTemplate.html'
                      ),
                      cellTemplate: g.get(
                        i.gridId + 'checkboxCellTemplate.html'
                      ),
            ...
            var n = w.config.showSelectionCheckbox
              ? w.config.groups.length + 1
              : w.config.groups.length;
            (i.configGroups.length = 0),
              angular.forEach(e, function(e, o) {
                ...
                var r = new C(
                  ...
                  l = w.config.groups.indexOf(e.field);
                -1 !== l &&
                  ((r.isGroupedBy = !0),
                  i.configGroups.splice(l, 0, r),
                  (r.groupIndex = i.configGroups.length)),
                  t.push(r);
              }),
              (i.columns = t);
          }
        ...
        (w.configureColumnWidths = function() {
          var e = w.config.columnDefs,
            t = w.config.showSelectionCheckbox
              ? i.configGroups.length + 1
              : i.configGroups.length,
            n = (e.length + t, []),
            o = [],
            r = 0,
            l = 0;
          if (
            ((l += w.config.showSelectionCheckbox ? 25 : 0),
            angular.forEach(e, function(e, a) {
              a += t;
              var s,
                c = !1;
              if (
                (d.isNullOrUndefined(e.width)
                  ? (e.width = '*')
                  : ((c = isNaN(e.width) ? d.endsWith(e.width, '%') : !1),
                    (s = c ? e.width : parseInt(e.width, 10))),
                isNaN(s))
              ) {
                if (((s = e.width), 'auto' === s)) {
                  (i.columns[a].width = e.minWidth), (l += i.columns[a].width);
                  var g = i.columns[a];
                  return (
                    u(function() {
                      w.resizeOnData(g, !0);
                ...
                if (-1 !== s.indexOf('*'))
                  return (
                    e.visible !== !1 && (r += s.length),
                    (e.index = a),
                    n.push(e),
                    void 0
                  );
                if (c) return (e.index = a), o.push(e), void 0;
                throw 'unable to parse column width, use percentage ("10%","20%", etc...) or "*" to use remaining width of grid';
              }
              e.visible !== !1 &&
                (l += i.columns[a].width = parseInt(e.width, 10));
            }),
            n.length > 0)
          ) {
            w.config.maintainColumnRatios =
              w.config.maintainColumnRatios !== !1;
            var s = w.rootDim.outerWidth - l;
            w.maxCanvasHt > i.viewportDimHeight() && (s -= a.ScrollW);
            var c = Math.floor(s / r);
            angular.forEach(n, function(e, t) {
              var o = t === n.length - 1,
                r = e.width.length;
              (i.columns[e.index].width = c * r),
                (i.columns[e.index].width -= o ? 0 : 2),
                e.visible !== !1 && (l += i.columns[e.index].width);
            });
          }
          o.length > 0 &&
            angular.forEach(o, function(e) {
              var t = e.width;
              i.columns[e.index].width = Math.floor(
                w.rootDim.outerWidth * (parseInt(t.slice(0, -1), 10) / 100)
              );
            });
        }),
        (w.init = function() {
          return w.initTemplates().then(function() {
            (i.selectionProvider = new D(w, i, f)),
              ...
              i.$watch(
                'columns',
                function(e) {
                  a.BuildStyles(i, w, !0), i.$emit('ngGridEventColumns', e);
                },
                !0
              ),
              i.$watch(
              ...
              w.config.sortInfo.fields &&
                ...
                (w.getColsFromFields(), w.sortActual());
          });
        }),
          ...
          if (n && n.shiftKey && w.config.sortInfo) {
            ...
            -1 === o
              ? (1 === w.config.sortInfo.columns.length &&
                  (w.config.sortInfo.columns[0].sortPriority = 1),
        ...
        (w.getColsFromFields = function() {
          w.config.sortInfo.columns
            ...
            angular.forEach(i.columns, function(e) {
              ...
              return (
                -1 !== t &&
                  ((e.sortDirection = w.config.sortInfo.directions[t] || 'asc'),
                  w.config.sortInfo.columns.push(e)),
                !1
              );
            });
        ...
        (w.fixColumnIndexes = function() {
          for (var e = 0; i.columns.length > e; e++)
            i.columns[e].visible !== !1 && (i.columns[e].index = e);
        }),
            ...
            var t = 0,
              ...
              c = function(e) {
                l
                  ? r.push(e)
                  : i.renderedColumns[s]
                    ? i.renderedColumns[s].setVars(e)
                    : (i.renderedColumns[s] = e.copy()),
                  s++;
              },
              g = 0;
            o > g;
        ...
        (i.adjustScrollTop = function(e, t) {
          if (w.prevScrollTop !== e || t) {
            e > 0 &&
              w.$viewport[0].scrollHeight - e <= w.$viewport.outerHeight() &&
              i.$emit('ngGridEventScroll');
            var r,
        ...
        (i.topPanelHeight = function() {
          return w.config.showGroupPanel === !0
            ? w.config.headerRowHeight + 32
            : w.config.headerRowHeight;
        }),
        (i.viewportDimHeight = function() {
          return Math.max(
            0,
            w.rootDim.outerHeight - i.topPanelHeight() - i.footerRowHeight - 2
          );
        }),
        (i.groupBy = function(e) {
          if (!(1 > w.data.length) && e.groupable && e.field) {
            e.sortDirection ||
              e.sort({ shiftKey: i.configGroups.length > 0 ? !0 : !1 });
            var t = i.configGroups.indexOf(e);
            -1 === t
              ? ((e.isGroupedBy = !0),
                i.configGroups.push(e),
                (e.groupIndex = i.configGroups.length))
              : i.removeGroup(t),
        ...
        (i.removeGroup = function(e) {
          ...
          (t.isGroupedBy = !1),
            (t.groupIndex = 0),
            i.columns[e].isAggCol &&
              (i.columns.splice(e, 1),
              i.configGroups.splice(e, 1),
              w.fixGroupIndexes()),
        ...
        (i.togglePin = function(e) {
          for (
            var t = e.index, n = 0, o = 0;
            i.columns.length > o && i.columns[o].pinned;
            o++
          )
            n++;
    ...
    (I.prototype.toggleSelected = function(e) {
      ...
      return 'checkbox' === t.type &&
        ...
        : this.config.selectWithCheckboxOnly && 'checkbox' !== t.type
          ...
          : (this.beforeSelectionChange(this, e) && this.continueSelection(e),
            !1);
    }),
  ...
  var R = function(e, t, o, i, r) {
      ...
      (g.aggCache = {}),
          ...
          return (
            o ||
              ((o = new w(
                t,
                g,
                g.rowConfig.rowHeight,
                e.config.groupsCollapsedByDefault
              )),
              (g.aggCache[t.aggIndex] = o)),
            (o.rowIndex = n),
        ...
        (g.renderedChange = function() {
          ...
          var t = 0,
            n = g.parsedData.filter(function(e) {
              return e.isAggRow
                ? e.parent && e.parent.collapsed
                  ? !1
                  : !0
                : (e[s] || (e.rowIndex = t++), !e[s]);
            });
          g.totalRows = n.length;
          for (
            var o = [], i = g.renderedRange.topRow;
            g.renderedRange.bottomRow > i;
            i++
          )
        ...
        (g.renderedChangeNoGroups = function() {
          for (
            var t = [], n = g.renderedRange.topRow;
            g.renderedRange.bottomRow > n;
            n++
          )
            e.filteredRows[n] &&
              ((e.filteredRows[n].rowIndex = n),
              (e.filteredRows[n].offsetTop = n * e.config.rowHeight),
              t.push(e.filteredRows[n]));
          e.setRenderedRows(t);
        }),
        ...
        (g.parseGroupData = function(e) {
          if (e.values)
            for (var t = 0; e.values.length > t; t++)
              g.parentCache[g.parentCache.length - 1].children.push(
                e.values[t]
              ),
                g.parsedData.push(e.values[t]);
          else
            for (var n in e)
              if (n !== l && n !== a && n !== c && e.hasOwnProperty(n)) {
                ...
                g.numberOfAggregates++,
                  ...
                  o.parent &&
                    ((o.parent.collapsed = !1), o.parent.aggChildren.push(o)),
                  g.parsedData.push(o),
        ...
        (g.getGrouping = function(n) {
          ...
          for (
            var u = e.filteredRows, f = n.length, h = t.columns, p = 0;
            u.length > p;
            p++
          ) {
            var m = u[p].entity;
        ...
        (i.evalFilter = function() {
          var e = function(e) {
            for (var t = 0, n = r.length; n > t; t++) {
              ...
              if (!s.column) {
                for (var c in e)
                  if (e.hasOwnProperty(c)) {
                    ...
                    g &&
                      g.cellFilter &&
                      ((u = g.cellFilter.split(':')), (d = o(u[0])));
                    var f = e[c];
                    if (null != f) {
                      if ('function' == typeof d) {
                        var h =
                          '' +
                          d('object' == typeof f ? l(f, g.field) : f, u[1]);
                        a = s.regex.test(h);
                      } else
                        a = s.regex.test(
                          'object' == typeof f ? '' + l(f, g.field) : '' + f
                        );
                      if (f && a) return !0;
                    }
                  }
              ...
              var p = i.fieldMap[s.columnDisplay];
              if (!p) return !1;
              var m = p.cellFilter.split(':'),
                v = p.cellFilter ? o(m[0]) : null,
                w = e[s.column] || e[p.field.split('.')[0]];
              if (null == w) return !1;
              if ('function' == typeof v) {
                var C = '' + v('object' == typeof w ? l(w, p.field) : w, m[1]);
                a = s.regex.test(C);
              } else
                a = s.regex.test(
                  'object' == typeof w ? '' + l(w, p.field) : '' + w
                );
              if (!w || !a) return !1;
            }
            return !0;
          ...
          n.filteredRows =
            0 === r.length
              ? n.rowCache
              : n.rowCache.filter(function(t) {
                  return e(t.entity);
                });
          for (var t = 0; n.filteredRows.length > t; t++)
            n.filteredRows[t].rowIndex = t;
            ...
            for (var o = n.split(';'), i = 0; o.length > i; i++) {
              ...
              if (l.length > 1) {
                ...
                s &&
                  ...
                  r.push({
                    column: s,
                    columnDisplay: s.replace(/\s+/g, '').toLowerCase(),
                    regex: a(c, 'i')
                  });
              } else {
                var g = t.trim(l[0]);
                g && r.push({ column: '', regex: a(g, 'i') });
              }
            }
        };
      e.$watch(
        ...
        e.$watch('filterText', function(t) {
          i.extFilter ||
            (e.$emit('ngGridEventFilter', t), s(t), i.evalFilter());
        }),
        i.extFilter ||
          e.$watch('columns', function(e) {
            for (var t = 0; e.length > t; t++) {
              var n = e[t];
              n.field && (i.fieldMap[n.field.split('.')[0]] = n),
                n.displayName &&
                  (i.fieldMap[
                    n.displayName.toLowerCase().replace(/\s+/g, '')
                  ] = n);
            }
          });
    },
        ...
        (o.ChangeSelection = function(n, i) {
          ...
          if (
            ...
            if (o.lastClickedRow) {
              ...
              return (
                (o.lastClickedRow = n), (o.lastClickedRowIndex = n.rowIndex), !0
              );
            }
          } else
            o.multi
              ...
              : o.lastClickedRow === n
                ? o.setSelection(
                    o.lastClickedRow,
                    e.config.keepLastSelected ? !0 : !n.selected
                  )
                : (o.lastClickedRow && o.setSelection(o.lastClickedRow, !1),
                  o.setSelection(n, !n.selected));
          return (
            (o.lastClickedRow = n), (o.lastClickedRowIndex = n.rowIndex), !0
          );
            ...
            if (n)
              -1 === o.selectedItems.indexOf(t.entity) &&
                (!o.multi &&
                  ...
                  o.toggleSelectAll(!1, !0),
                o.selectedItems.push(t.entity));
            else {
              var i = o.selectedItems.indexOf(t.entity);
              -1 !== i && o.selectedItems.splice(i, 1);
            }
            (t.selected = n),
              t.orig && (t.orig.selected = n),
              t.clone && (t.clone.selected = n),
              t.afterSelectionChange(t);
          }
        }),
        (o.toggleSelectAll = function(t, n, i) {
          ...
          if (n || e.config.beforeSelectionChange(r, t)) {
            ...
            for (var a = 0; r.length > a; a++)
              (r[a].selected = t),
                r[a].clone && (r[a].clone.selected = t),
                t && o.selectedItems.push(r[a].entity);
  ...
  p.directive('ngCellHasFocus', [
    ...
    function(e) {
      var t = function(t, n) {
        ...
        i.length > 0 &&
          (angular.element(i).focus(),
          t.domAccessProvider.selectInputElement(i[0]),
          angular.element(i).bind('blur', function() {
          ...
          n.bind('keydown', function(i) {
            return (
              o &&
                ...
                13 !== i.keyCode &&
                t(e, n),
              i.shiftKey && i.keyCode >= 65 && 90 >= i.keyCode && t(e, n),
              ...
              pre: function(t, n) {
                ...
                t.col.enableCellEdit
                  ? ((o = t.col.cellEditTemplate),
                    ...
                    (o = o.replace(
                      f,
                      t.col.editableCellTemplate.replace(
                        d,
                        'row.entity.' + t.col.field
                      )
                    )))
                ...
                t.enableCellSelection &&
                  ...
                  r.addClass('ngCellElement')),
                  n.append(r);
              },
              post: function(e, n) {
                e.enableCellSelection &&
                  e.domAccessProvider.selectionHandlers(e, n),
        ...
        var n = {
          ...
          compile: function() {
            return {
              pre: function(n, o) {
                0 === o.children().length &&
                  o.append(e(t.get(n.gridId + 'footerTemplate.html'))(n));
              }
            };
          }
        };
        ...
        var n = {
          ...
          compile: function() {
            return {
              pre: function(n, o) {
                0 === o.children().length &&
                  o.append(e(t.get(n.gridId + 'menuTemplate.html'))(n));
              }
            };
          }
        };
                ...
                return m.init().then(function() {
                  if (
                    ...
                    'string' == typeof p.totalServerItems
                      ? d.$parent.$watch(p.totalServerItems, function(e) {
                          d.totalServerItems = angular.isDefined(e) ? e : 1;
                        })
                      : (d.totalServerItems = p.totalServerItems),
                    ...
                    var n = function(e) {
                      (m.data = t.extend([], e)),
                        ...
                        angular.forEach(m.data, function(e, t) {
                          var n = m.rowMap[t] || t;
                          m.rowCache[n] && m.rowCache[n].ensureEntity(e),
                            (m.rowMap[n] = t);
                        }),
                        m.searchProvider.evalFilter(),
                        m.configureColumnWidths(),
                        m.refreshDomSizes(),
                        m.config.sortInfo.fields.length > 0 &&
                          (m.getColsFromFields(),
                          m.sortActual(),
                          m.searchProvider.evalFilter(),
                  ...
                  return (
                    ...
                    (p.selectRow = function(e, t) {
                      m.rowCache[e] &&
                        (m.rowCache[e].clone &&
                          m.rowCache[e].clone.setSelection(t ? !0 : !1),
                        m.rowCache[e].setSelection(t ? !0 : !1));
                    }),
          ...
          compile: function() {
            return {
              pre: function(o, i) {
                if (
                  ((o.row.elm = i),
                  o.row.clone && (o.row.clone.elm = i),
                  o.row.isAggRow)
                ) {
                  var r = n.get(o.gridId + 'aggregateTemplate.html');
                  (r = o.row.aggLabelFilter
                    ? r.replace(g, '| ' + o.row.aggLabelFilter)
                    : r.replace(g, '')),
                    i.append(e(r)(o));
    ...
    (e.ngGrid.i18n.de = {
      ...
      ngGroupPanelDescription:
        'Ziehen Sie eine Spaltenüberschrift hier und legen Sie es der Gruppe nach dieser Spalte.',
    ...
    (e.ngGrid.i18n.fr = {
      ...
      ngGroupPanelDescription:
        'Faites glisser un en-tête de colonne ici et déposez-le vers un groupe par cette colonne.',
    ...
    (e.ngGrid.i18n.sp = {
      ...
      ngGroupPanelDescription:
        'Arrastre un encabezado de columna aquí y soltarlo para agrupar por esa columna.',
