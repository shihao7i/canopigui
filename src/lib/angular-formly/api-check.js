...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['apiCheck'] = factory();
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function getApiCheckInstance() {
          ...
          if (apiCheckApiCheck && arguments.length) {
            apiCheckApiCheck['throw'](
              apiCheckApis.getApiCheckInstanceCheckers,
              arguments,
              {
          ...
          var disabled =
            apiCheck.disabled || module.exports.globalConfig.disabled;
          ...
          function apiCheck(api, args, output) {
            ...
            if (
              apiCheck.config.disabled ||
              module.exports.globalConfig.disabled
            ) {
              return {
                apiTypes: {},
                argTypes: {},
            ...
            if (messages.length) {
              returnObject.message = apiCheck.getErrorMessage(
                api,
                args,
                messages,
                output
          ...
          function checkApiCheckApi(checkApiArgs) {
            ...
            // dog fooding here
            var errors = checkApiWithArgs(
              apiCheckApis.checkApiCheckApi,
              checkApiArgs
            );
            if (errors.length) {
              var message = apiCheck.getErrorMessage(
                apiCheckApis.checkApiCheckApi,
                checkApiArgs,
                errors,
                {
            ...
            function getUrl() {
              ...
              if (!u) {
                u =
                  gOut.docsBaseUrl &&
                  output.urlSuffix &&
                  ('' + gOut.docsBaseUrl + '' + output.urlSuffix).trim();
              }
              return u;
            }
          }
              ...
              each(obj, function(val, name) {
                ...
                if (replacedItems.indexOf(val) === -1) {
                  ...
                  if (typeof val === 'object') {
                    ...
                    obj[name] =
                      val.displayName || val.name || 'anonymous function';
                  }
                }
              });
            }
          ...
          function getTypes(api, args) {
            ...
            var apiTypes = api.map(function(checker, index) {
              var specified = module.exports.globalConfig.hasOwnProperty(
                'verbose'
              );
              return getCheckerDisplay(checker, {
                terse: specified
                  ? !module.exports.globalConfig.verbose
        ...
        function checkApiWithArgs(api, args) {
          ...
          while ((checker = api[checkerIndex++]) && argIndex < args.length) {
            ...
            argName =
              'Argument ' +
              argIndex +
              (checker.isOptional ? ' (optional)' : '');
            res = checker(arg, 'value', argName);
            argFailed = isError(res);
            lastChecker = checkerIndex >= api.length;
            skipPreviousChecker =
              checkerIndex > 1 && api[checkerIndex - 1].isOptional;
            if (
              (argFailed && lastChecker) ||
              (argFailed &&
                !lastChecker &&
                !checker.isOptional &&
                !skipPreviousChecker)
        ...
        function checkerTypeType(checkerType, name, location) {
          ...
          var wrongShape = checkers.oneOfType([asFunc, asShape])(
            checkerType,
            name,
            location
          );
          ...
          if (
            typeof checkerType !== 'function' &&
            !checkerType.hasOwnProperty(checkerType.__apiCheckData.type)
          ) {
        ...
        function getApiCheckApis() {
          ...
          var getApiCheckInstanceCheckers = [
            checkers.shape({
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function getCheckerDisplay(checker, options) {
          ...
          if (short && checker.shortType) {
            ...
            (!short && typeof checker.type === 'object') ||
            checker.type === 'function'
          ) {
            display = getCheckerType(checker, options);
          } else {
            display =
              getCheckerType(checker, options) ||
              checker.displayName ||
              checker.name;
          }
          return display;
        ...
        function list(arry, join, finalJoin) {
          ...
          return (
            copy.join(join) +
            ('' + (copy.length ? join + finalJoin : '') + '' + last)
          );
        }
        ...
        function getError(name, location, checkerType) {
          ...
          var stringType =
            typeof checkerType !== 'object'
              ? checkerType
              : stringify(checkerType);
          return new Error(
            '' + nAtL(name, location) + ' must be ' + t(stringType)
          );
        }
          ...
          var requiredChecker = disabled
            ...
            : function requiredChecker(val, name, location, obj) {
                if (undef(val) && !checker.isOptional) {
                  ...
                  var stringType =
                    typeof type !== 'object' ? type : stringify(type);
                  return new Error(
                    'Required ' +
                      t(name) +
                      ' not specified' +
        ...
        function addNullable(checker, disabled) {
          var nullableCheck = disabled
            ? getNoop()
            : function nullableCheck(val, name, location, obj) {
                if (val !== null) {
                  return checker(val, name, location, obj);
                }
              };
        ...
        function fixType(checker, checkerCopy) {
          ...
          checkerCopy.type.__apiCheckData =
            copy(checker.type.__apiCheckData) || {}; // and this
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function getCheckers(disabled) {
          ...
          function typeOfCheckGetter(type) {
            ...
            return setupChecker(
              function typeOfCheckerDefinition(val, name, location) {
                if (typeOf(val) !== lType) {
          ...
          function funcCheckGetter() {
            var type = 'Function';
            var functionChecker = setupChecker(
              function functionCheckerDefinition(val, name, location) {
            ...
            functionChecker.withProperties = function getWithPropertiesChecker(
              properties
            ) {
              var apiError = checkers.objectOf(checkers.func)(
                properties,
                'properties',
              ...
              return setupChecker(
                function functionWithPropertiesChecker(val, name, location) {
          ...
          function objectCheckGetter() {
            ...
            var objectNullOkChecker = setupChecker(
              function objectNullOkCheckerDefinition(val, name, location) {
                if (typeOf(val) !== 'object') {
            ...
            var objectChecker = setupChecker(
              function objectCheckerDefinition(val, name, location) {
                if (
                  val === null ||
                  isError(objectNullOkChecker(val, name, location))
                ) {
                  return getError(name, location, objectChecker.type);
                }
              },
              { type: type, nullOk: objectNullOkChecker },
              disabled
            );
          ...
          function instanceCheckGetter(classToCheck) {
            return setupChecker(
              function instanceCheckerDefinition(val, name, location) {
          ...
          function oneOfCheckGetter(enums) {
            ...
            var shortType =
              ...
              ']';
            return setupChecker(
              function oneOfCheckerDefinition(val, name, location) {
                if (
                  !enums.some(function(enm) {
                    return enm === val;
                  })
                ) {
          ...
          function oneOfTypeCheckGetter(typeCheckers) {
            ...
            return setupChecker(
              function oneOfTypeCheckerDefinition(val, name, location) {
                if (
                  !typeCheckers.some(function(checker) {
          ...
          function arrayOfCheckGetter(checker) {
            ...
            return setupChecker(
              function arrayOfCheckerDefinition(val, name, location) {
                if (
                  isError(checkers.array(val)) ||
          ...
          function objectOfCheckGetter(checker) {
            ...
            return setupChecker(
              function objectOfCheckerDefinition(val, name, location) {
          ...
          function typeOrArrayOfCheckGetter(checker) {
            ...
            return setupChecker(
              function typeOrArrayOfDefinition(val, name, location, obj) {
                if (
                  isError(
                    checkers.oneOfType([checker, checkers.arrayOf(checker)])(
                      val,
                      name,
                      location,
                      obj
          ...
          function getShapeCheckGetter() {
            function shapeCheckGetter(shape, nonObject) {
              ...
              function type() {
                ...
                each(shape, function(checker, prop) {
                  ...
                  var required = undef(parentRequired)
                    ? !checker.isOptional
                    : parentRequired;
                ...
                function modifyTypeDisplayToHelpOut(
                  theRet,
                  prop,
                  specified,
                  checker,
                  ...
                  if (!specified && required && !checker.isOptional) {
                    ...
                    if (isError(error)) {
                      addHelper(
                        'error',
                        'THIS IS THE PROBLEM: ' + error.message,
                        ' <-- THIS IS THE PROBLEM: ' + error.message
                      );
                    }
                  }
              ...
              var shapeChecker = setupChecker(
                function shapeCheckerDefinition(val, name, location) {
                  /* eslint complexity:[2, 6] */
                  var isObject =
                    !nonObject && checkers.object(val, name, location);
                  if (isError(isObject)) {
                    return isObject;
                  }
              ...
              strictType.__apiCheckData = copy(
                shapeChecker.type.__apiCheckData
              );
              strictType.__apiCheckData.strict = true;
              shapeChecker.strict = setupChecker(
                function strictShapeCheckerDefinition(val, name, location) {
            ...
            shapeCheckGetter.ifNot = function ifNot(otherProps, propChecker) {
              ...
              if (otherProps.length === 1) {
                description =
                  'specified only if ' + otherProps[0] + ' is not specified';
              } else {
                description =
              ...
              var type = getTypeForShapeChild(
                propChecker,
                description,
                shortType
              );
              return setupChecker(
                function ifNotChecker(prop, propName, location, obj) {
                ...
                { notRequired: true, type: type, shortType: shortType },
                disabled
              );
            };
            ...
            shapeCheckGetter.onlyIf = function onlyIf(otherProps, propChecker) {
              ...
              if (otherProps.length === 1) {
                description =
                  'specified only if ' + otherProps[0] + ' is also specified';
              } else {
                description =
              ...
              return setupChecker(
                function onlyIfCheckerDefinition(
                  prop,
                  propName,
                  location,
                  obj
            ...
            shapeCheckGetter.requiredIfNot = function shapeRequiredIfNot(
              otherProps,
              propChecker
            ) {
              if (!Array.isArray(otherProps)) {
            ...
            shapeCheckGetter.requiredIfNot.all = function shapeRequiredIfNotAll(
              otherProps,
              propChecker
            ) {
              if (!Array.isArray(otherProps)) {
            ...
            function getRequiredIfNotChecker(all, otherProps, propChecker) {
              ...
              return setupChecker(
                function shapeRequiredIfNotDefinition(
                  ...
                  var otherPropsExist = otherProps[iteration](function(
                    otherProp
                  ) {
                    return obj && obj.hasOwnProperty(otherProp);
                  });
          ...
          function argumentsCheckerGetter() {
            ...
            return setupChecker(
              function argsCheckerDefinition(val, name, location) {
                if (
                  Array.isArray(val) ||
                  isError(checkers.object(val)) ||
                  isError(checkers.number(val.length))
                ) {
                  return getError(name, location, type);
                }
              },
          ...
          function nullCheckGetter() {
            var type = 'null';
            return setupChecker(
              function nullChecker(val, name, location) {
                if (val !== null) {
                  return getError(name, location, type);
                }
              },
          ...
          function rangeCheckGetter(min, max) {
            ...
            return setupChecker(
              function rangeChecker(val, name, location) {
          ...
          function lessThanCheckGetter(min) {
            ...
            return setupChecker(
              function lessThanChecker(val, name, location) {
          ...
          function greaterThanCheckGetter(max) {
            ...
            return setupChecker(
              function greaterThanChecker(val, name, location) {
          ...
          function emptyObjectCheckGetter() {
            ...
            return setupChecker(
              function emptyObjectChecker(val, name, location) {
                if (
                  typeOf(val) !== 'object' ||
                  val === null ||
