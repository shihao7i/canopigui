(function() {
    ...
    angular.module('canopi.directive')
           .directive('uiGridSelectionRowHeaderButtonsCanopi', uiGridSelectionRowHeaderButtonsCanopi);

    uiGridSelectionRowHeaderButtonsCanopi.$inject = ['$templateCache', 'uiGridSelectionService', 'Dialog', '$log'];    

    function uiGridSelectionRowHeaderButtonsCanopi($templateCache, uiGridSelectionService, Dialog, $log) {
        var directive = {
            replace: true,
            restrict: 'E',
        ...
        function link(scope, element, attrs, uiGridCtrl) {
            ...
            scope.remove = function (row, event) {
                Dialog.confirm("Are you sure you want to delete this item?").then(function(){
            ...
            scope.cancel = function (row, event) {
                ...
                uiGridSelectionService.toggleRowSelection(self, row, event, (self.options.multiSelect && !self.options.modifierKeysToMultiSelect), self.options.noUnselect);
            };
