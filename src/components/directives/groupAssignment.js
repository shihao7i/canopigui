...
(function() {
  ...
  function groupAssignment($log, $compile) {
    ...
    function link(scope, element, attrs) {
        ...
        if (scope.leftItems !== undefined) {
          leftGridOptions = {
            ...
            afterSelectionChange: function(row, event) {
              $log.debug(
                'leftGridOptions selectedItems length = ' +
                  scope.leftSelectedItems.length
              );
            }
          };
      ...
      scope.$watch('rightItems', function() {
        ...
        if (scope.rightItems !== undefined) {
          rightGridOptions = {
            ...
            afterSelectionChange: function(row, event) {
              $log.debug(
                'rightGridOptions selectedItems length = ' +
                  scope.rightSelectedItems.length
              );
            }
          };
      ...
      scope.$watch(
        'dataReady.leftGroupListOptionsReady+dataReady.rightGroupListOptionsReady',
        function() {
          if (
            scope.dataReady['leftGroupListOptionsReady'] &&
            scope.dataReady['rightGroupListOptionsReady']
          ) {
      ...
      scope.moveToRight = function() {
        ...
        var success = scope.deleteItems({
          itemsToBeRemoved: scope.leftSelectedItems
        });
      ...
      scope.moveToLeft = function() {
        ...
        var success = scope.addItems({
          itemsToBeAdded: scope.rightSelectedItems
        });
