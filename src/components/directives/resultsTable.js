(function() {
  ...
  angular
    ...
    .directive('searchResultTable', searchResultTable);

  searchResultTable.$inject = [
    '$window',
    '$filter',
    '$compile',
    '$location',
  ...
  function searchResultTable(
    ...
    function link(scope, element, attrs, controller) {
        ...
        if (scope.tableData.loadTrigger > 0) {
          ...
          if (scope.lastColumnDefs != undefined)
            localStorage.setItem(
              getLocalStorageKey() + '_COL',
              angular.toJson(scope.lastColumnDefs)
            );
        }
      };
      ...
      scope.$watch('tableData.loadTrigger', function(
        newTriggerVal,
        oldTriggerVal
      ) {
        ...
        if (scope.tableData.tableDefinition !== undefined) {
          ...
          var item = scope.tableData.tableDefinition.rowMetaData || {
            columnList: []
          };
          ...
          if (scope.tableData.tableDefinition.rowValueList != undefined) {
            for (
              var i = 0;
              i < scope.tableData.tableDefinition.rowValueList.length;
              i++
            ) {
              ...
              for (var n = 0; n < rowValue.cellValues.length; n++) {
                ...
                obj[
                  scope.tableData.tableDefinition.rowMetaData.columnList[n].id
                ] = rowValue.cellValues[n];
              }
          ...
          if (
            isExistingTable &&
            (localColumnDefs.length > 0 || newTriggerVal == 0)
          ) {
          ...
          if (newTriggerVal > 0) {
            ...
            if (dataTable == null) {
              ...
              if (
                ...
                (scope.addPagination === 'false' ||
                  scope.addPagination === undefined) &&
                (scope.addExport === 'false' ||
                  scope.addExport === undefined) &&
                (scope.addColumnShowHide === 'false' ||
                  scope.addColumnShowHide === undefined)
              ) {
                sDomString =
                  "<'row'<'col-md-12'f>>t<'row'<'col-xs-12 col-md-4'i><'col-xs-12 col-md-8'>>";
                includePagination = false;
                paginationHeight = '250px';
              } else if (
                scope.addFilter === 'true' &&
                scope.addPagination === 'true' &&
                (scope.addExport === 'false' ||
                  scope.addExport === undefined) &&
                (scope.addColumnShowHide === 'false' ||
                  scope.addColumnShowHide === undefined)
                ...
                sDomString =
                  "<'row'<'col-md-12'f>>t<'row'<'col-xs-12 col-md-4'i><'col-xs-12 col-md-8'T>>";
                includePagination = false;
                paginationHeight = '250px';
              } else if (
                scope.addFilter === 'true' &&
                ...
                (scope.addExport === 'false' ||
                  scope.addExport === undefined) &&
                scope.addColumnShowHide === 'true'
              ) {
                sDomString =
                  "<'row'<'col-md-12'Cf>>t<'row'<'col-xs-12 col-md-4'i><'col-xs-12 col-md-8'>>";
                includePagination = false;
                paginationHeight = '250px';
              } else if (
                ...
                sDomString =
                  "<'row'<'col-md-12'>>t<'row'<'col-xs-12 col-md-4'i><'col-xs-12 col-md-8'>>";
              } else if (
                (scope.addFilter === 'false' ||
                  scope.addFilter === undefined) &&
                scope.addPagination === 'true' &&
                ...
                sDomString =
                  "<'row'<'col-md-12'>>t<'row'<'col-xs-12 col-md-4'i><'col-xs-12 col-md-8'T>>";
              } else if (
                (scope.addFilter === 'false' ||
                  scope.addFilter === undefined) &&
                scope.addPagination === 'true' &&
                ...
                sDomString =
                  "<'row'<'col-md-12'C>>t<'row'<'col-xs-12 col-md-4'i><'col-xs-12 col-md-8'>>";
              } else if (
                (scope.addFilter === 'false' ||
                  scope.addFilter === undefined) &&
                (scope.addPagination === 'false' ||
                ...
                sDomString =
                  "<'row'<'col-md-12'C>>t<'row'<'col-xs-12 col-md-4'i><'col-xs-12 col-md-8'T>>";
                includePagination = false;
                paginationHeight = '250px';
              } else if (
                (scope.addFilter === 'false' ||
                ...
                sDomString =
                  "t<'row'<'col-xs-12 col-md-4'i><'col-xs-12 col-md-8'>>";
              }
      ...
      function getTableCreateOptions(
        columns,
        type,
        includePagination,
        paginationHeight
