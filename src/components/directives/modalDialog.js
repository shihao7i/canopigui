(function() {
  ...
  angular.module('canopi.directive').directive('modalDialog', modalDialog);
  ...
  function modalDialog() {
    var directive = {
      ...
      template:
        '<div class="modal fade" id="{{dialogId}}" draggable tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">' +
