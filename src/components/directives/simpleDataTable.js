...
(function() {
  ...
  angular
    ...
    .directive('simpleDatatable', simpleDatatable);

  simpleDatatable.$inject = [
    '$window',
    '$filter',
    '$compile',
    '$location',
        ...
        if (scope.tableData.tableDefinition !== undefined) {
          ...
          if (scope.tableData.tableDefinition.rowMetaData !== undefined) {
            for (
              var i = 0;
              i <
              scope.tableData.tableDefinition.rowMetaData.rowValueList.length;
              i++
            ) {
              var rowValue =
                scope.tableData.tableDefinition.rowMetaData.rowValueList[i];
              var obj = {};
