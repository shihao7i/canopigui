  ...
  function commonUtilJsonService($q, $http, $log, Cache, CanopiGuiConstants) {
    ...
    var baseUrl = (function() {
      ...
      if (CanopiGuiConstants.END_TO_END_REST_CALL) {
        ...
        baseUrl =
          'http://' +
          CanopiGuiConstants.HOSTNAME_PORT_SETTING_FROM_NETBEANS +
          '/canopigui/rest/' +
          controllerName;
        //}
      }
    ...
    function getServerInfo() {
      ...
      if (CanopiGuiConstants.END_TO_END_REST_CALL) {
        ...
        fullUrl =
          '/gui-canopi-js/src/app/admin-app/mock/adminmain/response/serverinfo.json';
      }
    ...
    function isAdminGuiAuthorizedUser(attUid) {
      ...
      if (CanopiGuiConstants.END_TO_END_REST_CALL) {
        ...
        // running from NetBeans
        fullUrl =
          '/gui-canopi-js/src/app/admin-app/mock/adminmain/response/admin-user-check-response.json';
      }
