angular.module('canopi.app').controller('EquipmentModifyController', [
  '$scope',
  '$location',
  '$rootScope',
  '$state',
  ...
  function(
    ...
    function setupScopeValuesAndMethods() {
      ...
      $http
        .get('app/mock/telco/network/equipmentElementsResponse.json')
        .then(function(res) {
    ...
    function updateTreeData() {
      ...
      $scope.my_tree_handler = function(branch) {
        $http
          .get('app/mock/telco/network/shelvesInfoResponse.json')
          .then(function(res) {
            $scope.shelvesInfoResponseData = res.data;
            processResponseResult(
              $scope.shelvesInfoData,
              $scope.shelvesInfoResponseData
            );
          });
        var _ref;
