angular.module('canopi.app').controller('ChangeP2PEVCPOController', [
  '$scope',
  '$log',
  '$location',
  '$rootScope',
  ...
  function(
    ...
    function initializeScopeVariables() {
      ...
      $scope.radioList = [
        { id: 'radio1', value: 'Regular UNI Site A', isSelected: false },
        { id: 'radio2', value: 'MPA Shared UNI Site A', isSelected: false }
      ];
      $scope.radioList2 = [
        { id: 'radio1', value: 'Regular UNI Site Z', isSelected: false },
