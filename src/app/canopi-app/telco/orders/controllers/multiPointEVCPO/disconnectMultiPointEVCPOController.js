angular.module('canopi.app').controller('DisconnectMultiPointEVCPOController', [
  '$scope',
  '$log',
  '$location',
  '$rootScope',
    ...
    function setupScopeMethods() {
      ...
      $scope.resultData = {
        tableRows: {
          rowMetaData: {
            columnList: [
              { hyperlink: true, id: 'orderId', displayName: 'UNI Circuit ID' },
              {
                hyperlink: false,
                id: 'customrName',
                displayName: 'Port Config'
              },
              ...
              { hyperlink: false, id: 'lcm', displayName: 'EVC CIR' },
              {
                hyperlink: false,
                id: 'usoNumber',
                displayName: 'COS Category, Package'
              },
              ...
              },
              {
                hyperlink: false,
                id: 'cancellationDate',
                displayName: 'Ingress Profile'
              },
              {
                hyperlink: false,
                id: 'InJeopardy',
                displayName: 'Egress Profile'
              },
              {
                hyperlink: false,
                id: 'strata',
                displayName: 'MAC Address Limit'
              }
            ]
          },
            ...
            columnList: [
              {
                hyperlink: true,
                id: 'orderId',
                displayName: 'MPA Shared UNI Facility ID'
              },
              {
                hyperlink: false,
                id: 'customrName',
              ...
              { hyperlink: false, id: 'creationDate', displayName: 'EVC GOS' },
              {
                hyperlink: false,
                id: 'completionDate',
                displayName: 'ICO UNI Circuit ID'
              },
              {
                hyperlink: false,
                id: 'cancellationDate',
                displayName: 'ICO EVC Circuit ID'
              },
              {
                hyperlink: false,
                id: 'InJeopardy',
                displayName: 'ICO SWC CLLI'
              },
              { hyperlink: false, id: 'strata', displayName: 'MIleage Band' },
              {
                hyperlink: false,
                id: 'custCode',
                displayName: 'ICO Connection Charge'
              }
            ]
          },
