angular.module('canopi.app').controller('ChangeMultiPointEVCPOController', [
  '$scope',
  '$log',
  '$location',
  '$rootScope',
    ...
    function setupScopeMethods() {
      ...
      $scope.resultData = {
        tableRows: {
          rowMetaData: {
            columnList: [
              { hyperlink: true, id: 'orderId', displayName: 'Site' },
              ...
              },
              {
                hyperlink: false,
                id: 'cancellationDate',
                displayName: 'B/M-BAND'
              },
              {
                hyperlink: false,
                id: 'InJeopardy',
                displayName: 'EVC MAC Limit'
              },
              {
                hyperlink: false,
                id: 'strata',
          ...
          rowMetaData: {
            columnList: [
              ...
              { hyperlink: false, id: 'customrName', displayName: 'Activity' },
              {
                hyperlink: false,
                id: 'status',
                displayName: 'Shared UNI Facility ID'
              },
              { hyperlink: false, id: 'lcm', displayName: 'Port Config' },
              { hyperlink: false, id: 'usoNumber', displayName: 'VLAN ID' },
              { hyperlink: false, id: 'creationDate', displayName: 'EVC CIR' },
              ...
              { hyperlink: false, id: 'strata', displayName: 'EVC GOS' },
              {
                hyperlink: false,
                id: 'custCode',
                displayName: 'ICO UNI Ckt ID'
              },
              {
                hyperlink: false,
                id: 'custName',
                displayName: 'ICO EVC Ckt ID'
              },
