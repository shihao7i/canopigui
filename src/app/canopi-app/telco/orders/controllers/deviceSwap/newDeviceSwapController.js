angular.module('canopi.app').controller('NewDeviceSwapController', ['$scope', '$log', '$location', '$rootScope', '$state', 'CommonUtilJsonService', 'OrderSearchJsonService', 'Cache', '$filter',
...
//	        };
	        ...
	        $scope.resultData= { "tableRows": 
				{"rowMetaData":
					{ "columnList":[ {"hyperlink":true, 	"id":"techorderId",		"displayName":"Service/Facility"},
					                 {"hyperlink":false,	"id":"suppNo",			"displayName":"Port Name"}] },
					                
				    "rowValueList":[ {"cellValues":[""]},
				                     {"cellValues":[""]},
				                     {"cellValues":[""]}]}};
			...
			{"rowMetaData":
				{ "columnList":[ {"hyperlink":true, 	"id":"techorderId",		"displayName":"Port Name"},
				                 {"hyperlink":true, 	"id":"techorderId",		"displayName":"SFP"},
				                 {"hyperlink":false,	"id":"suppNo",			"displayName":"Service/Facility"}] },
