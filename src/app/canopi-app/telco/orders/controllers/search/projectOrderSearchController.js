angular.module('canopi.app').controller('ProjectOrderSearchController', ['$log', '$location', '$rootScope', '$state', 'CommonUtilJsonService', 'OrderSearchJsonService', 'Cache', '$filter', '$timeout',
                                       function ($log, $location, $rootScope, $state, CommonUtilJsonService, OrderSearchJsonService, Cache, $filter, $timeout) {
    'use strict';
