angular.module('canopi.app').controller('NewUniPOController', [
  '$scope',
  '$log',
  '$location',
  '$rootScope',
    ...
    function populatePicklistValues() {
      ...
      $rootScope.$watch('picklists', function() {
        ...
        if ($rootScope.picklists !== undefined) {
          $scope.uniDiversityIndicatorList =
            $rootScope.picklists.uniDiversityIndicatorList;
          ...
          $scope.uniFiberCopperIndicatorList =
            $rootScope.picklists.uniFiberCopperIndicatorList;
          $scope.uniPiuList = $rootScope.picklists.uniPiuList;
          $scope.uniPortTypeOfFrameList =
            $rootScope.picklists.uniPortTypeOfFrameList;
          $scope.uniMacAddressLimitList =
            $rootScope.picklists.uniMacAddressLimitList;
