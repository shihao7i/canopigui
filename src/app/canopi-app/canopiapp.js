...
angular.module('canopi.app').config([
  '$stateProvider',
  '$urlRouterProvider',
  function($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
      ...
      .state('equipmentBuild', {
        ...
        templateUrl:
          'app/canopi-app/telco/network/views/build/equipmentBuild.html',
      ...
      .state('equipmentReview', {
        ...
        templateUrl:
          'app/canopi-app/telco/network/views/build/equipmentReview.html',
      ...
      .state('projectOrderSearch', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/search/projectOrderSearch.html',
      ...
      .state('technicalOrderSearch', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/search/technicalOrderSearch.html',
      ...
      .state('relatedOrdersSearch', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/search/relatedOrdersSearch.html',
      ...
      .state('disconnectUniPO', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/uniPO/disconnectUniPO.html',
      ...
      .state('newUniASEBBPO', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/uniASEBBPO/newUniASEBBPO.html',
      ...
      .state('changeUniASEBBPO', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/uniASEBBPO/changeUniASEBBPO.html',
      ...
      .state('disconnectUniASEBBPO', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/uniASEBBPO/disconnectUniASEBBPO.html',
      ...
      .state('newMultiPointEVCPO', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/multiPointEVCPO/newMultiPointEVCPO.html',
      ...
      .state('disconnectMultiPointEVCPO', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/multiPointEVCPO/disconnectMultiPointEVCPO.html',
      ...
      .state('changeMultiPointEVCPO', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/multiPointEVCPO/changeMultiPointEVCPO.html',
      ...
      .state('newInlCNLLAGPO', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/inlCNLLAGPO/newInlCNLLAGPO.html',
      ...
      .state('disconnectInlCNLPO', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/inlCNLLAGPO/disconnectInlCNLPO.html',
      ...
      .state('disconnectLagPO', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/inlCNLLAGPO/disconnectLagPO.html',
      ...
      .state('newAafCNLPO', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/inlCNLLAGPO/newAafCNLPO.html',
      ...
      .state('changeLagPO', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/inlCNLLAGPO/changeLagPO.html',
      ...
      .state('newP2PEVCPO', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/p2pEVCPO/newP2PEVCPO.html',
      ...
      .state('disconnectP2PEVCPO', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/p2pEVCPO/disconnectP2PEVCPO.html',
      ...
      .state('changeP2PEVCPO', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/p2pEVCPO/changeP2PEVCPO.html',
      ...
      .state('newDeviceSwap', {
        ...
        templateUrl:
          'app/canopi-app/telco/orders/views/deviceSwap/newDeviceSwap.html',
      ...
      .state('manageGroups', {
        ...
        templateUrl:
          'app/canopi-app/admin/views/manageGroups/manageGroups.html',
